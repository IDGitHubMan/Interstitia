...
params = {'cmd':'Page.setDownloadBehavior', 'params': {'behavior': 'allow', 'downloadPath': "/Users/isaiahdesrosiers/Documents/Projects/Interstitia/Projects/Google Trends Maps/Data/JSON/daily"}}
...
# with open("/Users/isaiahdesrosiers/Documents/Projects/Interstitia/Django/InterstitiaWebsite/static/Other/worldD.csv","r+") as f:
...
# with open("/Users/isaiahdesrosiers/Documents/Projects/Interstitia/Django/InterstitiaWebsite/static/Other/worldR.csv","r+") as f:
#     csv_reader = csv.DictReader(f,delimiter=',')
#     for row in csv_reader:
#         url = "https://trends.google.com/trends/api/dailytrends?hl=en-US&tz=240&geo=" + row["country_code"]+ "&ns=15"
#         print(row["country_code"])
...
def allCollector():
    with open("/Users/isaiahdesrosiers/Documents/Projects/Interstitia/Django/InterstitiaWebsite/static/Other/worldO.csv") as f:
        csv_reader = csv.DictReader(f,delimiter=',')
        for row in csv_reader:
            ...
            driver.get(url)
            time.sleep(5)
            r = csv.reader(open('/Users/isaiahdesrosiers/Documents/Projects/Interstitia/Projects/Google Trends Maps/Data/CSV/data.csv'))
            lines = list(r)
            for line in lines:
                if (line[3] == row["country_code"]):
                    try: 
                        ...
                        try:
                            ...
                            line[20] = "void"
                    break
        writer = csv.writer(open('/Users/isaiahdesrosiers/Documents/Projects/Interstitia/Projects/Google Trends Maps/Data/CSV/data.csv', 'w'))
