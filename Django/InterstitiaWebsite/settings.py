"""
Django settings for InterstitiaWebsite project.
...
SECRET_KEY = 'django-insecure-9&v$-us@ml6v8xtqzrchc0pn3e0&)f8gtd@$a0p$408fk$ftfc'
...
ROOT_URLCONF = 'InterstitiaWebsite.urls'
...
WSGI_APPLICATION = 'InterstitiaWebsite.wsgi.application'
